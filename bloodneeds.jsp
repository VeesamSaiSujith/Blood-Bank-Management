...
<table>
    ...
    String dbPassword ="rooter";
            ...
            String query = "SELECT name,bloodtype,quantity FROM bloodneeds";
            ...
            while (resultSet.next()) {
                ...
                String demail = resultSet.getString("bloodtype");
                String dphone = resultSet.getString("quantity");
